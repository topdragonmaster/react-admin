...
1.  Clone the repo `git clone https://github.com/smart-dev30/react-admin.git`
...
React Admin is built on top of [Create React App](https://github.com/facebook/create-react-app), which means all features that create-react-app supports are available.
